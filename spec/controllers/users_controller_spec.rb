...
describe UsersController do
  ...
  context 'Strong params' do
    ...
    it { should permit(:first_name, :last_name, :sex, :birth_date, :category, :type, :rankings, :phone_number, :active, :comments, :address, :postalcode, :city, :country).for(:create, params: { user: { first_name: '' } }).on(:user) }
    it { should permit(:first_name, :last_name, :sex, :birth_date, :category, :type, :rankings, :phone_number, :active, :comments, :address, :postalcode, :city, :country).for(:update, params: { id: user.id, user: { first_name: '' } }).on(:user) }
  end
end
