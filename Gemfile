...
# [turbolinks](https://github.com/turbolinks/turbolinks-rails)
gem "turbolinks", "~> 5.0"
...
group :development do
  ...
  # The Listen gem listens to file modifications and notifies you about the chan
...
# [tzinfo-data](http://tzinfo.github.io)
